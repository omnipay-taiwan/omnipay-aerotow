...
**Note:** Replace `omnipay-taiwan`, `:author_name`, `recca0120`, `:author_website`, `:author_email`, `aerotow`
, `:package_description` and `aerotow` with their correct values in [README.md](README.md)
